...
import com.ndroid.ecommerce.ui.setting.AddAddressActivity;
...
//                        intent.putExtra("id", userAddress.getId());
                    ...
                    loadingDialog.hide();
                    Toast.makeText(ChooseAddressActivity.this, "SUCCESS BUT ERROR", LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<UserAddress>> call, Throwable throwable) {
                loadingDialog.hide();
                Toast.makeText(ChooseAddressActivity.this, "ERROR", LENGTH_SHORT).show();
            }
        });
    }
}
