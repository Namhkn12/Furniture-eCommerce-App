package com.ndroid.ecommerce.chatbot;
...
public class ChatbotApiClient {
    ...
    private static final String API_URL = "http://14.189.204.107:25505/chat"; // 10.0.2.2 là địa chỉ localhost của máy host từ Android Emulator
