...
import com.example.baitaplonandroid.api.ReviewApiService;
...
//                Toast.makeText(ReviewActivity.this, "Rating: " + rating, Toast.LENGTH_SHORT).show();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.1.236:8083/") // sửa lại đúng URL backend của bạn
        ...
        call.enqueue(new Callback<ReviewModel>() {
            ...
            public void onResponse(Call<ReviewModel> call, Response<ReviewModel> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    allReviewsList.add(0, createdReview); // Thêm review mới vào đầu danh sách
