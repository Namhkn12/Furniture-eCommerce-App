...
import com.example.baitaplonandroid.ReviewAdapter;
...
public class ReviewActivity extends AppCompatActivity {
    ...
    private void setupCommentSubmission() {
        ...
        btnSubmitComment.setOnClickListener(v -> {
            ...
            float rating = ratingBarNewComment.getRating();
            ...
            newReview.setRatingText(getRatingText(rating));
            ...
            // Reset form
            editComment.setText("");
            ratingBarNewComment.setRating(5);
